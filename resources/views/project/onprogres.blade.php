...
@section('title', 'List Sedang Berjalan')

@section('pagetitle', 'List Sedang Berjalan')

@section('breadOld', 'List')

@section('breadNow', 'List Sedang Berjalan')
                    ...
                    <tbody>
                        ...
                        @empty
                          <div class="alert alert-warning alert-dismissible show" role="alert">
                            ...
                            <strong>Tidak Ada Pekerjaan Yang Sedang Berlangsung</strong>
                          </div>
                        @endforelse
                    </tbody>
                  </table>
              </div>
              {{ $onprogres->links('pagination::bootstrap-4') }}
            </div>
        </div>
    </div>
